export const phases = [
  {
    ...
    levels: [
      { id: 'uniapp-1', number: 1, type: 'concept', title: '页面与路由', concept: 'pages.json', difficulty: 'easy',
        ...
        microSteps:[{id:'step-1',title:'理解页面路由',verification:'pages.json',hint:'pages.json 定义页面路径和样式',docLinks:[{title: 'pages.json 路由配置', url: 'https://uniapp.dcloud.net.cn/collocation/pages.html'}]},{id:'step-2',title:'配置 TabBar',verification:'tabBar',hint:'tabBar 定义底部导航栏',docLinks:[{title: 'tabBar 配置', url: 'https://uniapp.dcloud.net.cn/collocation/pages.html#tabbar'}]}],
        docLinks: [
...
<style scoped>.card{display:flex;padding:20rpx;margin:10rpx;background:#fff;border-radius:16rpx}.price{color:#e54d42;font-size:32rpx;font-weight:bold}</style>`,
        ...
        microSteps:[{id:'step-1',title:'理解组件结构',verification:'defineProps',hint:'defineProps 接收父组件数据',docLinks:[{title: 'UniApp 组件', url: 'https://uniapp.dcloud.net.cn/component/component.html'}]},{id:'step-2',title:'使用 rpx 单位',verification:'rpx',hint:'rpx 是 UniApp 响应式单位',docLinks:[{title: 'rpx 单位', url: 'https://uniapp.dcloud.net.cn/tutorial/syntax-css.html#尺寸单位'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
  ...
  return new Promise((resolve,reject)=>{
    uni.request({
      ...
      fail:reject
        ...
        microSteps:[{id:'step-1',title:'理解封装原理',verification:'uni.request',hint:'用 Promise 封装异步请求',docLinks:[{title: 'uni.request', url: 'https://uniapp.dcloud.net.cn/api/request/request.html'}]},{id:'step-2',title:'添加 Token 拦截',verification:'Authorization',hint:'请求头自动携带 Token',docLinks:[{title: '拦截器', url: 'https://uniapp.dcloud.net.cn/api/request/request.html#拦截器'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
...
function goDetail(p){uni.navigateTo({url:"/pages/product/detail?id="+p.id})}
        ...
        microSteps:[{id:'step-1',title:'理解列表加载',verification:'onLoad',hint:'onLoad 页面首次加载时触发',docLinks:[{title: '页面生命周期 onLoad', url: 'https://uniapp.dcloud.net.cn/tutorial/page.html#生命周期'}]},{id:'step-2',title:'配置下拉刷新',verification:'onPullDownRefresh',hint:'开启 enablePullDownRefresh 配置',docLinks:[{title: '下拉刷新 onPullDownRefresh', url: 'https://uniapp.dcloud.net.cn/api/ui/pulldown.html'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
...
const total=computed(()=>cart.value.filter(x=>x.checked).reduce((s,x)=>s+x.price*x.num,0))
        ...
        cognitiveLoad: 'medium', dependsOn: ['uniapp-3'], commonMistakes: [], variations: [], transferTasks: [],
        microSteps:[{id:'step-1',title:'理解本地存储',verification:'uni.setStorageSync',hint:'setStorageSync 持久化购物车数据',docLinks:[{title: 'uni.setStorageSync', url: 'https://uniapp.dcloud.net.cn/api/storage/storage.html#setstoragesync'}]},{id:'step-2',title:'计算总价',verification:'computed',hint:'用 computed 计算选中商品总价',docLinks:[{title: '计算属性 computed', url: 'https://cn.vuejs.org/guide/essentials/computed.html'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
...
function toLogin(){uni.navigateTo({url:"/pages/login/login"})}
        ...
        microSteps:[{id:'step-1',title:'理解页面生命周期',verification:'onShow',hint:'onShow 每次页面显示都触发',docLinks:[{title: 'onShow 生命周期', url: 'https://uniapp.dcloud.net.cn/tutorial/page.html#生命周期'}]},{id:'step-2',title:'显示用户信息',verification:'uni.getStorageSync',hint:'读取本地用户信息并展示',docLinks:[{title: 'uni.getStorageSync', url: 'https://uniapp.dcloud.net.cn/api/storage/storage.html#getstoragesync'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
...
function submit(){if(!validate())return;uni.showToast({title:'保存成功',icon:'success'});setTimeout(()=>uni.navigateBack(),1500)}
        ...
        cognitiveLoad: 'medium', dependsOn: ['uniapp-3'], commonMistakes: [], variations: [], transferTasks: [],
        microSteps:[{id:'step-1',title:'理解地址CRUD',verification:'uni.request',hint:'封装地址的增删改查 API',docLinks:[{title: 'uni.request', url: 'https://uniapp.dcloud.net.cn/api/request/request.html'}]},{id:'step-2',title:'地址选择交互',verification:'@tap',hint:'点击地址卡片选择并回传',docLinks:[{title: '事件绑定 @tap', url: 'https://uniapp.dcloud.net.cn/tutorial/event.html'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
...
function submitOrder(){if(!addr.value)return uni.showToast({title:'请选择地址',icon:'none'});uni.showToast({title:'下单成功',icon:'success'});uni.redirectTo({url:'/pages/orders/orders'})}
        ...
        microSteps:[{id:'step-1',title:'理解订单流程',verification:'submitOrder',hint:'订单确认页面包含地址和商品列表',docLinks:[{title: 'uni.redirectTo', url: 'https://uniapp.dcloud.net.cn/api/router.html#redirectto'}]},{id:'step-2',title:'提交与跳转',verification:'uni.redirectTo',hint:'下单成功后跳转到订单列表页',docLinks:[{title: 'uni.navigateTo', url: 'https://uniapp.dcloud.net.cn/api/router.html#navigateto'}]}],
        docLinks: [
        { title: 'uni-app 官方文档', url: 'https://uniapp.dcloud.net.cn/' },
        { title: 'uni-app API 文档', url: 'https://uniapp.dcloud.net.cn/api/' }
        ],
